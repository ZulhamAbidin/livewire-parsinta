            ...
            <div class="card mt-5 rounded-lg p-5 lg:p-7">
                ...
                <label class="mt-4 block">
                    ...
                    <span class="relative mt-1.5 flex">
                        <input
                            class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                            placeholder="Enter Password" type="password" name="password" value="{{ old('password') }}"
                ...
                <div class="mt-4 text-center text-xs+">
                    <p class="line-clamp-1">
                        ...
                        <a href="{{ route ('register') }}" class="text-primary transition-colors hover:text-primary-focus dark:text-accent-light dark:hover:text-accent"
                            href="guest/pages-singup-1.html">Create account</a>
                    </p>
                </div>
